...
/****** Object:  StoredProcedure [dbo].[pr_GetBatterStatsByTeamID]    Script Date: 8/25/2019 9:31:41 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[pr_GetBatterStatsByTeamID]
    @TeamID		INT,
	@PitchHand	VARCHAR(1) = NULL
AS
...
WHERE
	Player.TeamID = @TeamID AND
	(@PitchHand IS NULL OR PlayByPlay.PitchHand = @PitchHand)
GROUP BY
	Player.PlayerID,
	Player.FullName,
	Player.BatSide
